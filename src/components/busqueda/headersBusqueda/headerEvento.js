...
function AppHeaderEvento(props) {
    ...
    const filtrar = async(values) => {
        ...
        if(ciudad != undefined && ambiente != undefined && (nombre != undefined && nombre != "")){
            url = 'http://localhost:5000/api/evento/nombre_ciudad_ambiente/'
            ...
            url = 'http://localhost:5000/api/evento/nombre_ciudad'
            ...
            url = 'http://localhost:5000/api/evento/nombre_ambiente'
            ...
            url = 'http://localhost:5000/api/evento/ciudad/'
            ...
            url = 'http://localhost:5000/api/evento/ambiente/'
            ...
            url = 'http://localhost:5000/api/evento/nombre/'
            ...
            url = 'http://localhost:5000/api/evento/places/'
