...
function AppHeaderMonumento(props) {
    ...
    const filtrar = async(values) => {
        ...
        if(ciudad != undefined && ambiente != undefined && (nombre != undefined && nombre != "")){
            url = 'http://localhost:5000/api/monumento/nombre_ciudad_ambiente/'
            ...
            url = 'http://localhost:5000/api/monumento/ciudad_ambiente'
            ...
            url = 'http://localhost:5000/api/monumento/nombre_ciudad'
            ...
            url = 'http://localhost:5000/api/monumento/nombre_ambiente'
            ...
            url = 'http://localhost:5000/api/monumento/ciudad/'
            ...
            url = 'http://localhost:5000/api/monumento/ambiente/'
            ...
            url = 'http://localhost:5000/api/monumento/nombre/'
            ...
            url = 'http://localhost:5000/api/monumento/places/'
...
export default AppHeaderMonumento;