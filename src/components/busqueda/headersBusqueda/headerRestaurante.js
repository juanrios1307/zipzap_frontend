...
function AppHeaderRestaurante(props) {
    ...
    const filtrar = async(values) => {
        ...
        if(ciudad != undefined && ambiente != undefined && (nombre != undefined && nombre != "")){
            url = 'http://localhost:5000/api/restaurante/nombre_ciudad_ambiente/'
            ...
            url = 'http://localhost:5000/api/restaurante/nombre_ciudad'
            ...
            url = 'http://localhost:5000/api/restaurante/nombre_ambiente'
            ...
            url = 'http://localhost:5000/api/restaurante/ambiente/'
            ...
            url = 'http://localhost:5000/api/restaurante/nombre/'
